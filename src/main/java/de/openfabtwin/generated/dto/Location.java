...
public class Location {
  ...
  public Location x(@Nullable BigDecimal x) {
    this.x = x;
    return this;
  }
  ...
  public Location y(@Nullable BigDecimal y) {
    this.y = y;
    return this;
  }
  ...
  public Location z(@Nullable BigDecimal z) {
    this.z = z;
    return this;
  }
  ...
  public static class Builder {
    ...
    protected Builder copyOf(Location value) { 
    ...
    public Location.Builder x(BigDecimal x) {
      this.instance.x(x);
      return this;
    }
    
    public Location.Builder y(BigDecimal y) {
      this.instance.y(y);
      return this;
    }
    
    public Location.Builder z(BigDecimal z) {
      this.instance.z(z);
      return this;
    }
